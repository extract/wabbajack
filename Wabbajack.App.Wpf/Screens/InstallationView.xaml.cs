...
namespace Wabbajack
{
    ...
    public partial class InstallationView
    {
        public InstallationView()
        {
            ...
            {
                this.MarkAsNeeded<InstallationView, InstallerViewModel, bool>(this.ViewModel, x => x.Installing);
                this.MarkAsNeeded<InstallationView, InstallerViewModel, bool>(this.ViewModel, x => x.Slideshow.Enable);
